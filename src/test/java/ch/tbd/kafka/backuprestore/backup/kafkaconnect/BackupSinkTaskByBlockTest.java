...
/**
 * Class BackupSinkTaskByBlockTest.
 * This represents TODO.
 *
 * @author iorfinoa
 * @version $$Revision$$
 */
public class BackupSinkTaskByBlockTest extends AbstractTest {
    ...
    public void testBackupDataByBlock() {
        ...
        Assertions.assertEquals("BackupSinkTaskByBlockTest", this.connectorConfig.getName());
        Assertions.assertEquals("test-junit-topic-block-1,test-junit-topic-block-2", this.connectorConfig.getTopics());
        ...
        sinkRecordsList.add(new SinkRecord(topics.get(0), 0, Schema.BYTES_SCHEMA, "key".getBytes(), Schema.BYTES_SCHEMA, record.getBytes(), 0, new Date().getTime(), TimestampType.CREATE_TIME));
        sinkRecordsList.add(new SinkRecord(topics.get(0), 0, Schema.BYTES_SCHEMA, "key1".getBytes(), Schema.BYTES_SCHEMA, record.getBytes(), 1, new Date().getTime(), TimestampType.CREATE_TIME));
        sinkRecordsList.add(new SinkRecord(topics.get(0), 0, Schema.BYTES_SCHEMA, "key2".getBytes(), Schema.BYTES_SCHEMA, record.getBytes(), 2, new Date().getTime(), TimestampType.CREATE_TIME));
        sinkRecordsList.add(new SinkRecord(topics.get(1), 0, Schema.BYTES_SCHEMA, "key".getBytes(), Schema.BYTES_SCHEMA, record.getBytes(), 0, new Date().getTime(), TimestampType.CREATE_TIME));
        sinkRecordsList.add(new SinkRecord(topics.get(1), 0, Schema.BYTES_SCHEMA, "key1".getBytes(), Schema.BYTES_SCHEMA, record.getBytes(), 1, new Date().getTime(), TimestampType.CREATE_TIME));
        sinkRecordsList.add(new SinkRecord(topics.get(1), 0, Schema.BYTES_SCHEMA, "key2".getBytes(), Schema.BYTES_SCHEMA, record.getBytes(), 2, new Date().getTime(), TimestampType.CREATE_TIME));
