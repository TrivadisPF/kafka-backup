...
[Issue #30](https://github.com/TrivadisPF/kafka-backup/issues/30) describes two possible issues we discussed. Read more about the specifics under [Backup of Compacted Log Topics](./we Backup of Compacted Log Topics.md).
